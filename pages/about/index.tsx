...
const renderProfileSection = (
  { title, paragraphs }: ProfileSection,
  key?: number
) => {
  const renderParagraphs = () =>
    paragraphs.map((text, i) => (
      <p key={i}>
        {text.split('\n').map((text, i, originalArray) =>
...
const profileSections: ProfileSection[] = [
  ...
  },
  {
    title: '💪 Skills',
    paragraphs: [
      'JavaScript/TypeScript/React/React Nativeが好きで、フロントエンドを生業としています。仕事では主にTypeScriptを使ってReact Nativeアプリの開発、たまにElmを書きます。',
      '最近はdenoに興味津々。',
    ],
  },
  {
    title: '😍 Hobbies',
    paragraphs: [
      'カメラ/バイク/ドライブ/ガジェットへの散財、無印良品などなど多趣味です。\n広く浅いタイプ。',
    ],
  },
];
